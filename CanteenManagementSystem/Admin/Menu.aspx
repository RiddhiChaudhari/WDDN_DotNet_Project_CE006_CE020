<%@ Page Title="Menu for Today" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="Menu.aspx.cs" Inherits="CanteenManagementSystem.Admin.Menu" %>
                            ...
                            <ItemTemplate>
                                <div class="my-8  shadow-lg inline-block">
                                    ...
                                    <div style="padding-left:30px; padding-right:30px;">
                                        <div style="padding:5px; border:1px solid #ddd; border-radius:4px;">
